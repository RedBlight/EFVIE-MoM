...
[ I3SS ] = GenerateI3SS( waveNum, faceCount, vertexList, faceVertexIndex, faceTetraIndex, faceMidPoint, faceArea );
[ I3ST ] = GenerateI3ST( waveNum, tetraCount, faceCount, vertexList, tetraVertexIndex, faceTetraIndex, faceMidPoint, tetraMidPoint, tetraVol );
[ I3TS ] = GenerateI3TS( waveNum, tetraCount, faceCount, vertexList, faceVertexIndex, tetraMidPoint, faceMidPoint, faceArea );
[ I3TT ] = GenerateI3TT( waveNum, tetraCount, vertexList, tetraVertexIndex, tetraMidPoint, tetraVol );
