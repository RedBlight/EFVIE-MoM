function result = SingIntVec_Face( r_, vt_, v1_, v2_, v3_ )
	...
	result = SingIntVec_Edge( dirN, vecRho, magD, r_, vt_, v1_, v2_, v3_ );
	result = result + SingIntVec_Edge( dirN, vecRho, magD, r_, vt_, v2_, v3_, v1_ );
	result = result + SingIntVec_Edge( dirN, vecRho, magD, r_, vt_, v3_, v1_, v2_ );
	result = result .* dirN;
