function [ I22 ] = GenerateI22( waveNum, vertexList, tetraCount, tetraVertexIndex, tetraQuadCount, tetraQuadW, tetraQuadR )
	
	% I3VV( a, b )
	% a is tetra index
	% b is tetra index
		
	I22 = zeros( 3, tetraCount, tetraCount );
	...
	for idTetraB = 1 : tetraCount
		...
		for idTetraA = 1 : tetraCount
			...
			for idQuadB = 1 : tetraQuadCount
				...
				I22_S = I22_S + qBW_ .* ( qBR_ .* SIVol + SIVec );
				I22_R = I22_R + qBW_ .* RIVec;
				
			end
			
			I22( :, idTetraA, idTetraB ) = I22_S + I22_R;
