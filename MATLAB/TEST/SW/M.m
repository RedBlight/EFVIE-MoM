...
% 		end
		...
		function G = GreenRegInt( k, W, r1, r2 )
			dR = r2 - r1;
			R = M.VecLength( dR );
			if( R ~= 0 )
				g = ( exp( -1i .* k .* R ) - 1 ) ./ R;
		...
		function G = GreenRegIntVec( k, V, r1, r2 )
		...
		function G = GreenInt_Phi( k, W, r1, r2 )
...
% 			disp( size( g ) );
		...
		function G = GreenInt_A( k, W, rn, r1, r2 )
