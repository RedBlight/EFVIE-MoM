#ifndef FAR_FIELD_SCATTERER_INCLUDED
#define FAR_FIELD_SCATTERER_INCLUDED
...
public:
	FarFieldScatterer(
		...
		shared_ptr< complex< T > >& rcsData // preallocated
	) :
	...
	inline void GenerateSingleElem( const UINT_T& idFace )
	{			
		UINT_T idTetra[ 2 ] = {
